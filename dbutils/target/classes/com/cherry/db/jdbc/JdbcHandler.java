...
/**
 * DB JDBC 操作接口 定义并封装了一些常用的 JDBC 操作接口
 * @description: 
 * @author:Cherry
 * @version:1.0
 * @date:2012-3-17
...
public interface JdbcHandler extends Serializable
{
	...
	/**
	 * 保存一个使用了  DB Annotation 的对象到数据库
	 * <p>
	 * GDK-DB Annotation Example: (注：为了能让@在javadoc中显示，故在将@改为_@，在实际使用时请还原为@)
	 * <p>
	 * <hr>
	 * <blockquote>
	 * 
	 * <pre>
	 * _@Table(name = &quot;avatar_user&quot;)
	 * public class User
	 * {
	 ...
	 * <hr>
	 * 
	 * @param bean 使用了 GDK DB annotation 的对象
	 * @return 保存结果
	 */
	...
	/**
	 * 更新一个使用了 GDK DB Annotation 对象的部分属性到数据库
	 * <hr>
	 * <blockquote>
	 * User Annotation 参见 {@link #save(Object)} 的User样例
	 * <pre>
