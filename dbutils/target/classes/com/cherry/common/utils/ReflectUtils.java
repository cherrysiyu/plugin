...
public final class ReflectUtils
{
	...
	/*
	 * public static void main(String[] args) throws Exception { DataSource ds = new DataSource("a"); invokeMethod( ds, "maxConnectionSize", 10000 );
	 * invokeMethod( ds, "showSQL", true ); invokeMethod( ds, "connectionProvider", new Object[]{null} ); System.out.println(
	 * ds.getMaxConnectionSize() ); System.out.println( ds.getShowSQL() ); System.out.println( ds.getConnectionProvider() ); DataSource ds2 =
	 * (DataSource)newInstance("com.avatar.db.datasource.DataSource", "AA", "com.mysql.JdbcDriver", null, "root", "123"); System.out.println(
	 * ds2.getName() ); System.out.println( ds2.getDriverClass() ); System.out.println( ds2.getDriverUrl() ); }
	 */
