...
public class NamedSQL
{
	 ...
	 */
	private static final ConcurrentHashMap<String, NamedSQL> NAMED_SQL_CACHE= new ConcurrentHashMap<String, NamedSQL>();
	 ...
	 * @return NamedSQL
	 */
	public synchronized static NamedSQL parse(String namedSql)
	{
		NamedSQL namedSQL = NAMED_SQL_CACHE.get(namedSql);
		if( null == namedSQL )
		{
			namedSQL = parseNamedSQL(namedSql);
			NAMED_SQL_CACHE.put(namedSql, namedSQL);
		}
	...
	{
		System.out.println("start parse named sql: "+ namedSql);
