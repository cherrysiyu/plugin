...
import com.cherry.db.annotation.Column;
import com.cherry.db.annotation.ColumnType;
import com.cherry.db.annotation.GeneratorType;
import com.cherry.db.annotation.Table;
...
public final class PersistenceUtil
{
	...
	public static String getTableName( Class<?> clazz )
	{
		...
		if( null == table_name )
		{
			throw new IllegalArgumentException("Error: The  DB Annotation[@Table(name='...')] can not find in your JavaBean!");
		}
	...
	/**
	 * 解析一个使用了GDK-DB Annotation的类的注解属性映射关系
	 * 
	 * @param clazz 使用了GDK-DB Annotation的类
