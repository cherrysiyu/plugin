...
import com.cherry.db.datasource.DataSourceException;
import com.cherry.db.dialect.Dialect;
import com.cherry.common.utils.ClassLoaderUtils;
import com.cherry.common.utils.ObjectExtend;
import com.cherry.common.utils.XMLUtils;
import com.cherry.common.io.ClasspathResourceResolver;
import com.cherry.common.io.ResourceResolver;
...
public class Config
{
	...
	// 数据源配置文件格式
	private static final String			DATASOURCE_SCHEMA		= "META-INF/Cherry-db.xsd";
	// 默认数据源属性配置
