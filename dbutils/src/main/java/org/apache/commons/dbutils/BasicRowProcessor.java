...
import com.cherry.db.jdbc.JdbcUtil;
...
public class BasicRowProcessor implements RowProcessor {
    ...
    public Map<String, Object> toMap(ResultSet rs) throws SQLException {
        ...
        for (int i = 1; i <= cols; ++i)
        {
          ...
          if ((null == columnVal) || (0 == columnVal.toString().length()))
          {
            columnVal = "";
          }
          else {
            columnVal = JdbcUtil.processBigDecimal(columnVal, rs, i);
          }

          result.put(columnName, columnVal);
        }
